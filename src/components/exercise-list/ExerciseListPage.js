...
const ExerciseListPage = ({ exercises, onAddExercise }) => (
  <div>
    ...
    <div className="col-sm-10 p-0 mx-auto mb-5 py-3">
      <ExerciseList exercises={exercises} onAddExercise={onAddExercise} />
    </div>
    <nav className="navbar fixed-bottom navbar-light bg-white p-0 navbar-expand shadow-up-sm">
      <ul className="d-flex navbar-nav w-100">
        <li className="nav-item flex-grow-1">
          <button className="btn btn-link nav-link" onClick={() => onAddExercise()}>
